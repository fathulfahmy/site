...
function About() {
  return (
    <div className="lg:grid grid-cols-12">
      <div className="border-b-[1px] flex flex-col lg:col-span-8 gap-[32px] py-[48px] px-[16px] lg:gap-[48px] lg:py-[64px] lg:px-[40px] ">
        <section>
          ...
          <p>
            ...
            operating system. As I delved deeper into writing configurations and
            scripts for various components and software programs, I realized my
            passion for coding and decided to pursue a career in software
            engineering.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            contributions. I am particularly proud of launching my own projects,
            LunarKeymap and catppuccin/glazewm, which have allowed me to
            contribute to the broader tech community in unique ways.
          </p>
        </section>
        <section>
          <h3 className="about__heading">2024 - UI/UX design and JavaScript</h3>
          <p>
            Currently, my focus lies in the realms of UI/UX design, web
            development, and mobile application development. I find immense
            excitement in the ever-evolving landscape of technology and am eager
